    ...
    W: std::io::Write,
{
...

    {
        ...
        let top_bit = (0usize..64)
            .into_iter()
            .filter(|i| (n & (0b1usize << i)) > 0)
            .max()
            .unwrap();
...
mod tests {
    ...
    #[test]
    fn sample1() {
        assert_judge!(process, "5", "ABBA");
    }

    #[test]
    fn sample2() {
        // assert_judge!(process, "14", "BBABBAAAB");
        assert_judge!(process, "14", "ABABAB");
    }

    #[test]
    fn ex1() {
        assert_judge!(process, "1", "A");
    }

    #[test]
    fn ex2() {
        assert_judge!(process, "2", "AB");
    }

    #[test]
    fn ex3() {
        assert_judge!(process, "3", "ABA");
    }
}
