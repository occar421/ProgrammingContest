    ...
    W: std::io::Write,
{
...

    {
        ...
        fn can2(
            ...
            let l1 = (area1 + rest_x - 1) / rest_x;
            return false;
        }

        fn can3(x: usize, y: usize, rest_areas: &[usize]) -> bool {
            if rest_areas.len() == 0 {
                return true;
            }

            let target = rest_areas[0];
            let l1 = (target + x - 1) / x;
            let l2 = (target + l1 - 1) / l1;
            dbg!(l1, l2);

            can2(x, y, x - l1, y - l2, rest_areas[1], rest_areas[2]);
...
mod tests {
    ...
    #[test]
    fn sample1() {
        assert_judge!(process, "3 3 2 2 3", "Yes");
    }

    #[test]
    fn sample2() {
        assert_judge!(process, "3 3 4 4 1", "No");
    }
