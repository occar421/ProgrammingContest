    ...
    W: Write,
{
...

    {
        ...
        //
        // fn primes_under(n: usize) -> HashSet<usize> {
...
mod tests {
    ...
    #[test]
    fn sample1() {
        assert_judge!(process, "3 7", "2");
    }

    #[test]
    fn sample2() {
        assert_judge!(process, "4 10", "12");
    }

    #[test]
    fn sample3() {
        assert_judge!(process, "1 1000000", "392047955148");
    }
}
