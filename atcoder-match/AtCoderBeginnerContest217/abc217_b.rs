    ...
    W: std::io::Write,
{
...

    {
        ...
        let mut all_contests = HashSet::new();
        all_contests.insert("ABC".to_string());
        all_contests.insert("ARC".to_string());
        all_contests.insert("AGC".to_string());
        all_contests.insert("AHC".to_string());

        all_contests.remove(&s1);
        all_contests.remove(&s2);
        all_contests.remove(&s3);

        println!("{}", all_contests.iter().last().unwrap());
    }
