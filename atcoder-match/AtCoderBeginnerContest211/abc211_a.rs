...
mod tests {
    ...
    #[test]
    fn sample1() {
        assert_judge_with_error!(process, "130 100", "110", f64 | 10f64.powi(-5));
    }

    #[test]
    fn sample2() {
        assert_judge_with_error!(process, "300 50", "133.3333333", f64 | 10f64.powi(-5));
    }

    #[test]
    fn sample3() {
        assert_judge_with_error!(process, "123 123", "123", f64 | 10f64.powi(-5));
    }
}
