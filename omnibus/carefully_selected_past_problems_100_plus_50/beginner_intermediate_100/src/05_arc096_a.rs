    ...
    W: std::io::Write,
{
...

    {
        ...
        let min_xy = min!(x, y);
        let mut price = min!(2 * c, a + b) * min_xy;
        if x > y {
            price += min!(2 * c, a) * (x - min_xy);
        } else {
            price += min!(2 * c, b) * (y - min_xy);
        }
...
mod tests {
    ...
    #[test]
    fn sample1() {
        assert_judge!(process, "1500 2000 1600 3 2", "7900");
    }

    #[test]
    fn sample2() {
        assert_judge!(process, "1500 2000 1900 3 2", "8500");
    }

    #[test]
    fn sample3() {
        assert_judge!(process, "1500 2000 500 90000 100000", "100000000");
    }
}
