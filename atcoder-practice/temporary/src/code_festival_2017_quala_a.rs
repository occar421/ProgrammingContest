    ...
    W: Write,
{
    ...
    let is_yaki = S.starts_with("YAKI");
    write!(writer, "{}", if is_yaki { "Yes" } else { "No" })?;
...
mod tests {
    ...
    #[test]
    fn sample1() {
        assert_judge!(process, "YAKINIKU", "Yes");
    }

    #[test]
    fn sample2() {
        assert_judge!(process, "TAKOYAKI", "No");
    }

    #[test]
    fn sample3() {
        assert_judge!(process, "YAK", "No");
    }
}
