    ...
    W: Write,
{
    ...
    for n_10000 in 0..=n {
        for n_5000 in 0..=(n - n_10000) {
            let n_1000 = n - n_10000 - n_5000;

            if n_10000 * 10000 + n_5000 * 5000 + n_1000 * 1000 == y {
                writeln!(writer, "{} {} {}", n_10000, n_5000, n_1000)?;
                return Ok(());
            }
        }
    }

    writeln!(writer, "-1 -1 -1")?;
...
mod tests {
    ...
    fn calc(x: &[isize]) -> isize {
        x[0] * 10000 + x[1] * 5000 + x[2] * 1000
    }

    #[test]
    fn sample1() {
        // assert_judge!(process, "9 45000", "4 0 5");
        let output = assert_judge_with_output!(process, "9 45000");
        ...
        assert_eq!(45000, calc(&o));
    }

    #[test]
    fn sample2() {
        // assert_judge!(process, "20 196000", "-1 -1 -1");
        let output = assert_judge_with_output!(process, "20 196000");
    ...
    #[test]
    fn sample3() {
        // assert_judge!(process, "1000 1234000", "14 27 959");
        let output = assert_judge_with_output!(process, "1000 1234000");
        ...
        assert_eq!(1234000, calc(&o));
    }

    #[test]
    fn sample4() {
        // assert_judge!(process, "2000 20000000", "2000 0 0");
        let output = assert_judge_with_output!(process, "2000 20000000");
