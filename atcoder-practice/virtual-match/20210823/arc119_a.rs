...
mod tests {
    ...
    #[test]
    fn sample1() {
        assert_judge!(process, "998244353", "143");
    }

    #[test]
    fn sample2() {
        assert_judge!(process, "1000000007", "49483");
    }
    ...
    #[test]
    fn sample4() {
        assert_judge!(process, "998984374864432412", "2003450165");
    }
